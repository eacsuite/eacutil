...
A Block defines a earthcoin block that provides easier and more efficient
...
A Tx defines a earthcoin transaction that provides more efficient manipulation of
...
To decode/encode an address:
	...
	addr, err := eacutil.DecodeAddress(addrString, defaultNet)
	if err != nil {
		fmt.Println(err)
		return
	}
