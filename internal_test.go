...
/*
This test file is part of the eacutil package rather than than the
eacutil_test package so it can bridge access to the internals to properly test
...
// P2PKH and P2SH earthcoin addresses.
...
// bech32 encoded P2WPKH and P2WSH earthcoin addresses.
