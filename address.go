...
import (
	...
	"github.com/eacsuite/eacutil/bech32"
)
...
// and netID which encodes the earthcoin network and address type.  It is used
...
//
// The earthcoin network the address is associated with is extracted if possible.
...
// with the passed earthcoin network.
...
// https://github.com/earthcoin/bips/blob/master/bip-0173.mediawiki
