...
// Block defines a earthcoin block that provides easier and more efficient
...
// Tx returns a wrapped transaction (eacutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (eacutil.Tx) for all
...
// instead provides easy access to wrapped versions (eacutil.Tx) of them.
...
// NewBlock returns a new instance of a earthcoin block given an underlying
...
// NewBlockFromBytes returns a new instance of a earthcoin block given the
...
// NewBlockFromReader returns a new instance of a earthcoin block given a
...
// NewBlockFromBlockAndBytes returns a new instance of a earthcoin block given
