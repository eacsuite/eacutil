...
//   https://github.com/earthcoin/bips/blob/master/bip-0032.mediawiki
...
import (
	...
	"github.com/eacsuite/eacutil/base58"
)
...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := eacutil.Hash160(k.pubKeyBytes())[:4]
...
// Address converts the extended key to a standard earthcoin pay-to-pubkey-hash
// address for the passed network.
func (k *ExtendedKey) Address(net *chaincfg.Params) (*eacutil.AddressPubKeyHash, error) {
	pkHash := eacutil.Hash160(k.pubKeyBytes())
	return eacutil.NewAddressPubKeyHash(pkHash, net)
}
