...
import (
	...
	"github.com/eacsuite/eacutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    eacutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() eacutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value eacutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = eacutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = eacutil.NewTxFromBytes(testSimpleCoinTxBytes)
